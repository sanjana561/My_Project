...
function tableBodyFun() {
  ...
  <tr>
    <td>
      <div>
        <img src="../static/admin/assets/images/icons/file-manager-icon/file.png" class="w-20 h-20" alt="">
        ${$('#recentName').val()}
      </div>
    </td>
    <td>17</td>
    ...
    <div class="card">
      <div class="card-body folder-card">
        ...
        <div class="fileimage mb-2">
          <img src="../static/admin/assets/images/icons/file-manager-icon/folder.png" alt="" class="img-fluid">
