...
const radialBar7Options = {
  ...
  plotOptions: {
    radialBar: {
      hollow: {
        margin: 15,
        size: '70%',
        image: '../../static/admin/assets/images/icons/radial-bar-icon/icon-5.png',
        imageWidth: 64,
        imageHeight: 64,
        imageClipped: false
      },
  ...
  fill: {
    type: 'image',
    image: {
      src: ['../../static/admin/assets/images/slick/11.jpg'],
    }
  },
  stroke: {
    lineCap: 'round'
  ...
  plotOptions: {
    radialBar: {
      hollow: {
        margin: 15,
        size: "70%",
        image: '../../static/admin/assets/images/icons/radial-bar-icon/icon-4.png',
        imageWidth: 80,
        imageHeight: 80,
        imageClipped: false
      },
  ...
  plotOptions: {
    radialBar: {
      hollow: {
        margin: 15,
        size: "70%",
        image: '../../static/admin/assets/images/icons/radial-bar-icon/icon-2.png',
        imageWidth: 90,
        imageHeight: 90,
        imageClipped: false
      },
  ...
  plotOptions: {
    radialBar: {
      hollow: {
        margin: 15,
        size: "70%",
        image: '../../static/admin/assets/images/icons/radial-bar-icon/icon-3.png',
        imageWidth: 90,
        imageHeight: 90,
        imageClipped: false
      },
  ...
  plotOptions: {
    radialBar: {
      hollow: {
        margin: 15,
        size: "55%",
        image: '../../static/admin/assets/images/icons/radial-bar-icon/icon-6.png',
        imageWidth: 110,
        imageHeight: 110,
        imageClipped: false
      },
  ...
  plotOptions: {
    radialBar: {
      hollow: {
        margin: 15,
        size: "55%",
        image: '../../static/admin/assets/images/icons/radial-bar-icon/icon-8.png',
        imageWidth: 120,
        imageHeight: 120,
        imageClipped: false
      },
