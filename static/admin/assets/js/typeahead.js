...
const countries = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.whitespace,
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: "../static/admin/assets/vendor/typeahead/data/countries.json",
});
...
const bestPictures = new Bloodhound({
    ...
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../static/admin/assets/vendor/typeahead/data/post_1960.json',
});
...
const nbaTeams = new Bloodhound({
    ...
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../static/admin/assets/vendor/typeahead/data/nba.json'
});

const nhlTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../static/admin/assets/vendor/typeahead/data/nhl.json'
});
